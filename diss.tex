...
% \documentclass[balanced,twoside,openany,11pt]{ubcdiss/ubcdiss}
...
% To correct error due to unicode characters in .bib file from Mendeley.
...
\makeatletter
\renewcommand{\chaptermark}[1]{\markboth{\MakeUppercase{\@chapapp\ \thechapter.\ #1}}{}}
\makeatother
\fancyhead[CE,CO]{\slshape \leftmark}
...
\examiningcommittee{Edmond Cretu, Electrical and Computer Engineering}{Additional Examiner (Chair)}
\examiningcommittee{Matthew Yedlin, Electrical and Computer Engineering}{Additional Examiner}
...
%% files
\hypersetup{
  pdftitle={On the Design of Stable, High Performance Sigma Delta Modulators},
...
\input{glossary.tex}	% always input, since other macros may rely on it
