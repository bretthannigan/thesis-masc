...
\begin{enumerate}
	...
	\item The parameters \var{maxIter}, $\epsilon$, and $\kappa$ used in the iterative optimization process are difficult to choose and may need to be set based on the chosen stability criteria. Example values used by the author are listed in \autoref{tab:params}.
